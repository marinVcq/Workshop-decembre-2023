...
from .views import home, login_view,logout, register, lessons, lesson_detail, complete_lesson, exercises, memory_rules, start_memory_game, memorize_words, submit_answers
